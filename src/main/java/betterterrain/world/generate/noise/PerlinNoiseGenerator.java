...
public class PerlinNoiseGenerator extends NoiseGenerator {
    ...
    public final double lerp(double factor, double start, double end) {
    ...
    public void populateNoiseArray2D(double[] noiseArray, double xOffset, double zOffset,
                                     int xSize, int zSize, double xScale, double zScale, double noiseScale) {
        int noiseIndex = 0;
    ...
    public void populateNoiseArray3D(double[] noiseArray, double xOffset, double yOffset, double zOffset,
