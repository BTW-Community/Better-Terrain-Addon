	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
			...
			else
			{
				...
				if ((var11 == Block.grass.blockID || var11 == Block.dirt.blockID || (BTAMod.isDecoInstalled() && (var11 == DecoBlocks.coarseDirt.blockID || var11 == DecoBlocks.podzol.blockID))) && par4 < 256 - var6 - 1)
				{
