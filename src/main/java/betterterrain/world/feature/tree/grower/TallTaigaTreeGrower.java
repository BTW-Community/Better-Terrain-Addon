...
public class TallTaigaTreeGrower extends AbstractTreeGrower {
	protected TallTaigaTreeGrower(String name, int minTreeHeight, int maxTreeHeight, TreeGrowers.TreeWoodType woodType) {
