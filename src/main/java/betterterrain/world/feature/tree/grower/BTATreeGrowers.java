...
public class BTATreeGrowers {
    ...
    public static final AbstractTreeGrower STEPPE_TREE = new SteppeTreeGrower("betterterrain:steppe_tree", 10, 14, TreeGrowers.OAK_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower OAK_ASPEN_TREE = new AspenTreeGrower("betterterrain:oak_aspen", 6, 10, TreeGrowers.OAK_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower LARGE_MEADOW_OAK_TREE = new BranchingTreeGrower("betterterrain:large_meadow_oak", 15, 22, TreeGrowers.OAK_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower MEDIUM_SPRUCE_TREE = new MediumTaigaTreeGrower("betterterrain:medium_spruce", 9, 17, TreeGrowers.SPRUCE_WOOD_TYPE);
    public static final AbstractTreeGrower TALL_SPRUCE_TREE = new TallTaigaTreeGrower("betterterrain:tall_spruce", 13, 21, TreeGrowers.SPRUCE_WOOD_TYPE);
    public static final AbstractTreeGrower BIG_SPRUCE_TREE = new BigTaigaTreeGrower("betterterrain:big_spruce", 10, 19, TreeGrowers.SPRUCE_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower MEADOW_SPRUCE_TREE = new TemperateTreeGrower("betterterrain:meadow_spruce", 9, 12, TreeGrowers.SPRUCE_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower TEMPERATE_BIRCH_TREE = new TemperateTreeGrower("betterterrain:temperate_birch", 9, 12, TreeGrowers.BIRCH_WOOD_TYPE);
    ...
    public static final AbstractTreeGrower MEADOW_DARK_OAK_TREE = new TemperateTreeGrower("betterterrain:meadow_dark_oak", 9, 12, DecoWoodTypeHelper.darkOakWoodType());
    public static final AbstractTreeGrower LARGE_MEADOW_DARK_OAK_TREE = new BranchingTreeGrower("betterterrain:large_meadow_dark_oak", 15, 22, DecoWoodTypeHelper.darkOakWoodType());
