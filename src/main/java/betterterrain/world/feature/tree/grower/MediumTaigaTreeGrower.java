...
public class MediumTaigaTreeGrower extends AbstractTreeGrower {
	protected MediumTaigaTreeGrower(String name, int minTreeHeight, int maxTreeHeight, TreeGrowers.TreeWoodType woodType) {
