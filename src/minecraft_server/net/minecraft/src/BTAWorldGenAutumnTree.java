...
public class BTAWorldGenAutumnTree extends WorldGenerator {
	private static int leafMeta = 0;
	
	public BTAWorldGenAutumnTree(int leafMeta) {
				...
				for (int var13 = var2 - var12; var13 <= var2 + var12 && var10; ++var13)
				{
					for (var14 = var4 - var12; var14 <= var4 + var12 && var10; ++var14)
					{
						if (var11 >= 0 && var11 < 256)
						{
							...
							if (!var0.isAirBlock(var13, var11, var14) && var15 != Block.leaves.blockID && var15 != Block.grass.blockID && var15 != Block.dirt.blockID && var15 != Block.wood.blockID && var15 != BTADecoIntegration.cherryLog.blockID && var15 != BTADecoIntegration.cherryLeaves.blockID || var15 == BTADecoIntegration.autumnLeaves.blockID)
							{
								var10 = false;
							}
						}
			...
			else
			{
				...
				if (FCUtilsTrees.CanSaplingGrowOnBlock(var0, var2, var3 - 1, var4) && var3 < 256 - var9 - 1)
				{
					...
					for (var14 = 0; var14 < var9; ++var14)
					{
						...
						if (var0.isAirBlock(var2, var3 + var14, var4) || var15 == Block.leaves.blockID || var15 == BTADecoIntegration.autumnLeaves.blockID || var15 == BTADecoIntegration.cherryLeaves.blockID)
						{
