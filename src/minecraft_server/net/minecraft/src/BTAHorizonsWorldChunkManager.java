...
public class BTAHorizonsWorldChunkManager extends WorldChunkManager {
	...
	public BTAHorizonsWorldChunkManager() {
	...
	public BTAHorizonsWorldChunkManager(long seed, WorldType worldType) {
        this();
        GenLayer[] layers = BTAHorizonsGenLayer.initializeAllBiomeGenerators(seed, worldType);
        this.genBiomes = layers[0];
        this.biomeIndexLayer = layers[1];
	}

	public BTAHorizonsWorldChunkManager(World world) {
