...
public class BTAWorldGenTaiga5 extends WorldGenerator
{
	public BTAWorldGenTaiga5(boolean par1)
	{
		super(par1);
	}
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
			...
			else
			{
				...
				if ((var11 == Block.grass.blockID || var11 == Block.dirt.blockID || (BTADecoIntegration.isDecoInstalled() && (var11 == BTADecoIntegration.coarseDirt.blockID || var11 == BTADecoIntegration.podzol.blockID))) && par4 < 256 - var6 - 1)
				{
