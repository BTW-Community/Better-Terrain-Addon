	...
	protected void decorate()
	{
		...
		for (var1 = 0; var1 < this.clayPerChunk; ++var1)
		{
			if (this.currentWorld.rand.nextInt(3) != 0) {
				var2 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				var3 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				if (this.currentWorld.provider.terrainType == BTAMod.BTAWorldTypeSky) {
		...
		{
			if (BTADecoIntegration.isDecoInstalled() && (this.currentWorld.provider.terrainType == BTAMod.BTAWorldTypeDeco || this.currentWorld.provider.terrainType == BTAMod.BTAWorldTypeBetaDeco)) {
