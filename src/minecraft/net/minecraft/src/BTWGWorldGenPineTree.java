...
public class BTWGWorldGenPineTree extends WorldGenerator
{
	...
	public BTWGWorldGenPineTree(boolean par1) {
		this(par1, 0, 0);
	}
	
	public BTWGWorldGenPineTree(boolean par1, int metaWood, int metaLeaves) {
		super(par1);
