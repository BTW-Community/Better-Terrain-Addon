...
public abstract class BTWGMapGenStructure extends BTWGMapGenBase
{
    /**
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, int[] blockArray)
    {
        if (!this.structureMap.containsKey(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(par2, par3))))
        {
            ...
            catch (Throwable var10)
            {
                ...
                var9.addCrashSectionCallable("Is feature chunk", new BTWGCallableIsFeatureChunk(this, par2, par3));
                var9.addCrashSection("Chunk location", String.format("%d,%d", new Object[] {Integer.valueOf(par2), Integer.valueOf(par3)}));
                var9.addCrashSectionCallable("Chunk pos hash", new BTWGCallableChunkPosHash(this, par2, par3));
                var9.addCrashSectionCallable("Structure type", new BTWGCallableStructureType(this));
