...
public class BTAWorldGenCherryTreeBig extends WorldGenerator
{
    /**
    ...
    public BTAWorldGenCherryTreeBig(boolean par1)
    {
        super(par1);
    }
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var16 != 0 && var16 != BTADecoIntegration.cherryLeaves.blockID)
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, BTADecoIntegration.cherryLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, BTADecoIntegration.cherryLog.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (byte)BTADecoIntegration.cherryLog.blockID);
            }
        }
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            if (var8 == BTADecoIntegration.cherryLog.blockID)
            {
