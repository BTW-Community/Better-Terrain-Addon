...
public class BTAWorldGenMinable extends WorldGenerator
{
    ...
    private int mineableMetadata;

    /** The number of blocks to generate. */
    private int numberOfBlocks;
    private int field_94523_c;

    public BTAWorldGenMinable(int par1, int par2, int par3)
    {
        this(par1, par2, par3, Block.stone.blockID);
    }

    public BTAWorldGenMinable(int par1, int par2, int par3, int par4)
    {
        this.minableBlockId = par1;
        this.mineableMetadata = par2;
        this.numberOfBlocks = par3;
        this.field_94523_c = par4;
    }
                            ...
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlockId(var38, var41, var44) == this.field_94523_c)
                                {
                                    ...
                                    if (var48.HasStrata() && var41 <= 48 + par1World.rand.nextInt(2))
                                    {
                                        ...
                                        int strata2Height = par1World.provider.terrainType == BTAMod.BTAWorldTypeSky ? 32 : 24;
