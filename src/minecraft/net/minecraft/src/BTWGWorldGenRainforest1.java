...
public class BTWGWorldGenRainforest1 extends WorldGenerator
{
	...
	public BTWGWorldGenRainforest1(boolean par1)
	{
		this(par1, 8, 3, 3, false);
	}

	public BTWGWorldGenRainforest1(boolean par1, int par2, int par3, int par4, boolean par5)
	{
		super(par1);
		minTreeHeight = par2;
		metaWood = par3;
