...
public class BTWGWorldGenPalmTreeSmall extends WorldGenerator {
	...
	public BTWGWorldGenPalmTreeSmall(boolean par1) {
		this(par1, 6, 3, 3, false);
	}

	public BTWGWorldGenPalmTreeSmall(boolean par1, int par2, int par3, int par4, boolean par5)
	{
		super(par1);
