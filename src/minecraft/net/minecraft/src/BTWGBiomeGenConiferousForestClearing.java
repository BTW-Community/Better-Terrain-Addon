...
public class BTWGBiomeGenConiferousForestClearing extends BTWGBiomeGenBase {
	public BTWGBiomeGenConiferousForestClearing(int id) {
		super(id);
    ...
    public WorldGenerator getRandomWorldGenForTrees(Random rand)
    {
    	...
    	if (rand.nextInt(5) == 0) {
    		...
    		gen = new BTWGWorldGenTaiga5(false);
    	}
    	else {
