...
public class BTWGWorldChunkManager extends WorldChunkManager {
	...
	public BTWGWorldChunkManager(long par1, WorldType par3WorldType) {
        this();
        GenLayer[] var4 = BTWGGenLayer.initializeAllBiomeGenerators(par1, par3WorldType);
        this.genBiomes = var4[0];
        this.biomeIndexLayer = var4[1];
	}

	public BTWGWorldChunkManager(World par1World) {
