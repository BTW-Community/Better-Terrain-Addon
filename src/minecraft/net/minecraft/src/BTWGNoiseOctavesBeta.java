...
public class BTWGNoiseOctavesBeta extends NoiseGenerator
{
    private BTWGNoisePerlinBeta[] generatorCollection;
    private int octaves;

    public BTWGNoiseOctavesBeta(Random var1, int var2)
    {
        this.octaves = var2;
        this.generatorCollection = new BTWGNoisePerlinBeta[var2];

        for (int var3 = 0; var3 < var2; ++var3)
        {
            this.generatorCollection[var3] = new BTWGNoisePerlinBeta(var1);
        }
    }
