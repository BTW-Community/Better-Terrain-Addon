...
public class BTWGGenLayerRiverMix extends BTWGGenLayer
{
    private GenLayer biomePatternGeneratorChain;
    private GenLayer riverPatternGeneratorChain;

    public BTWGGenLayerRiverMix(long par1, GenLayer par3GenLayer, GenLayer par4GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int var8 = 0; var8 < par3 * par4; ++var8)
        {
            ...
            {
                if (BTWGBiomeConfiguration.getRiverVariantForBiomes(var5[var8]) != -1)
                {
                    var7[var8] = BTWGBiomeConfiguration.getRiverVariantForBiomes(var5[var8]);
                }
