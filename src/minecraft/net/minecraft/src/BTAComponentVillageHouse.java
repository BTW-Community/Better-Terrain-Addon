...
public class BTAComponentVillageHouse extends BTAComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        int var10 = this.startPiece.GetAbandonmentLevel(par1World);
        int var11 = 0;

        if (var10 == 0)
        {
            var11 = Block.thinGlass.blockID;
        }
        ...
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 0, 2, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 0, 2, 3, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.wood.blockID, 0, 4, 2, 0, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 5, 2, 0, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 8, 2, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 8, 2, 3, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 8, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 8, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 2, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 2, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, var11, 0, 5, 4, 10, par3StructureBoundingBox);
