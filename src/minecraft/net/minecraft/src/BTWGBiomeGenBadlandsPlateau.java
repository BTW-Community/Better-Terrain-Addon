...
public class BTWGBiomeGenBadlandsPlateau extends BTWGBiomeGenBase {
	private ArrayList<Integer> allowedTerracottaMetadata = new ArrayList();
	
	public BTWGBiomeGenBadlandsPlateau(int id) {
		super(id);
		if (BTWGDecoIntegration.isDecoInstalled()) {
			this.topBlockExt = BTWGDecoIntegration.terracotta.blockID;
			this.fillerBlockExt = BTWGDecoIntegration.terracotta.blockID;
		}
