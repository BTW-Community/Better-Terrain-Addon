...
public class BTWGBiomeGenRiverTropics extends BTWGBiomeGenBase {
	protected BTWGBiomeGenRiverTropics(int id) {
		super(id);
		this.waterColorMultiplier = BTWGBiomeConfiguration.tropics.waterColorMultiplier;
    ...
    {
    	return BTWGBiomeConfiguration.tropics.getBiomeGrassColor();
    }
    ...
    {
    	return BTWGBiomeConfiguration.tropics.getBiomeFoliageColor();
    }
}