...
public class BTWGGenLayerShore extends BTWGGenLayer
{
    public BTWGGenLayerShore(long par1, GenLayer par3GenLayer)
    {
        super(par1);
        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
                ...
                else if (var9 != BiomeGenBase.ocean.biomeID && var9 != BiomeGenBase.river.biomeID && var9 != BiomeGenBase.swampland.biomeID && var9 != BiomeGenBase.extremeHills.biomeID)
                {
                    ...
                    {
                    	if (BTWGBiomeConfiguration.getBeachVariantForBiomes(var9) != -1) {
                    		var6[var8 + var7 * par3] = BTWGBiomeConfiguration.getBeachVariantForBiomes(var9);
                    	}
                    	else if (BTWGBiomeConfiguration.shouldBiomeSpawnBeach(var9)){
