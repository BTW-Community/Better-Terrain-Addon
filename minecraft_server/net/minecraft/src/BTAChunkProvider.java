...
public class BTAChunkProvider implements BTAIChunkProvider
{
	/** RNG. */
	private Random rand;
	...
	public void generateTerrain(int chunkX, int chunkZ, int[] blockArray)
	{
		...
		if (this.generatorInfo.getCompatMode().isVersionAtLeast(BTAEnumVersionCompat.V1_4_0)) {
			this.noiseArray = BTASurfaceBuilder.initializeNoiseField(this.rand, this.seed, this.noiseArray, chunkX * var4, 0, chunkZ * var4, var7, var8, var9, biomesForGeneration);
		}
		else {
