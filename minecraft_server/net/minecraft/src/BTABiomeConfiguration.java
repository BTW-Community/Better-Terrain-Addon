...
public class BTABiomeConfiguration {
	...
	public static final BTABiomeGenBase icyPeaks = new BTABiomeGenIcyPeaks(ICY_PEAKS_ID, BTAEnumClimate.SNOWY).setColor(16421912).setBiomeName("Icy Peaks").setEnableSnow().setTemperatureRainfall(0.1F, 0.1F).setMinMaxHeight(0.5F, 1.5F);
	...
	public static final BTABiomeGenBase desertHills = new BTABiomeGenDesert(DESERT_HILLS_ID, BTAEnumClimate.ARID).setColor(16421912).setBiomeName("Better Desert Hills").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.3F, 1.0F);
    ...
    public static final BTABiomeGenBase jungleHills = new BTABiomeGenJungle(JUNGLE_HILLS_ID, BTAEnumClimate.TROPICAL).setColor(2900485).setBiomeName("Better Jungle Hills").func_76733_a(5470985).setTemperatureRainfall(1.2F, 0.9F).setMinMaxHeight(1.8F, 0.5F);
    ...
    // ------ Nether Biomes ------ //
	public static final BTABiomeGenBase netherWastes = new BTABiomeGenNetherWastes(NETHER_WASTES_ID).setColor(16711680).setBiomeName("Nether Wastes").setDisableRain().setTemperatureRainfall(2.0F, 0.0F);
	public static final BTABiomeGenBase ashFields = new BTABiomeGenAshFields(ASH_FIELDS_ID).setColor(16711680).setBiomeName("Ash Fields").setDisableRain().setTemperatureRainfall(2.0F, 0.0F);
	public static final BTABiomeGenBase basaltDeltas = new BTABiomeGenBasaltDeltas(BASALT_DELTAS_ID).setColor(16711680).setBiomeName("Basalt Deltas").setDisableRain().setTemperatureRainfall(2.0F, 0.0F);
	public static final BTABiomeGenBase soulSandValley = new BTABiomeGenSoulSandValley(SOUL_SAND_VALLEY_ID).setColor(16711680).setBiomeName("Soul Sand Valley").setDisableRain().setTemperatureRainfall(2.0F, 0.0F);
	public static final BTABiomeGenBase obsidianGrove = null;
	public static final BTABiomeGenBase crystalCaverns = new BTABiomeGenCrystalCaverns(CRYSTAL_CAVERNS_ID).setColor(16711680).setBiomeName("Crystal Caverns").setDisableRain().setTemperatureRainfall(2.0F, 0.0F);
