...
public class BTAWorldGenNetherLava extends WorldGenerator {
	private boolean isOpenToAir;
	
	public BTAWorldGenNetherLava(boolean isOpenToAir) {
	...
	private boolean isBlockValidForReplacement(int blockID) {
		return blockID == Block.netherrack.blockID || (BTADecoIntegration.isDecoInstalled() && blockID == BTADecoIntegration.basalt.blockID) || blockID == Block.blockNetherQuartz.blockID;
	}
}