...
public class BTAChunkProviderNether implements BTAIChunkProvider
{
    ...
    public BTAChunkProviderNether(World world, long seed, BTAWorldConfigurationInfo generatorInfo)
    {
        this.worldObj = world;
    ...
    public Chunk provideChunk(int chunkX, int chunkZ)
    {
		...
		BTASurfaceBuilder.replaceSurface(this.hellRNG, this.seed, chunkX, chunkZ, blockArray, metaArray, biomesForGeneration, generatorInfo, this.worldObj.provider.terrainType);
    ...
    public void populate(IChunkProvider par1IChunkProvider, int chunkX, int chunkZ)
    {
        ...
        if (b instanceof BTABiomeGenBase)
			((BTABiomeGenBase) b).decorate(this.worldObj, this.hellRNG, x, z, this.generatorInfo);
		else
