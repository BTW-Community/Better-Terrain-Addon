...
public class BTABetaNoiseOctaves extends NoiseGenerator
{
    private BTABetaNoisePerlin generatorCollection[];
    private int field_1191_b;

    public BTABetaNoiseOctaves(Random random, int i)
    {
        field_1191_b = i;
        generatorCollection = new BTABetaNoisePerlin[i];
        for(int j = 0; j < i; j++)
        {
            generatorCollection[j] = new BTABetaNoisePerlin(random);
        }
