...
public class BTAWorldGenMinable extends WorldGenerator
{
	...
	public BTAWorldGenMinable(int id, int numBlocks)
	{
		minableBlockId = id;
	...
	public BTAWorldGenMinable(int id, int meta, int numBlocks, int replaceID) {
		this(id, meta, numBlocks, new int[] {replaceID});
	}

	public BTAWorldGenMinable(int id, int meta, int minBlocks, int maxBlocks, int replaceID) {
		this(id, meta, minBlocks, maxBlocks, new int[] {replaceID});
	}

	public BTAWorldGenMinable(int id, int meta, int numBlocks, int[] replaceIDs) {
		this(id, meta, numBlocks, numBlocks, replaceIDs);
	}

	public BTAWorldGenMinable(int id, int meta, int minBlocks, int maxBlocks, int[] replaceIDs) {
		minableBlockId = id;
