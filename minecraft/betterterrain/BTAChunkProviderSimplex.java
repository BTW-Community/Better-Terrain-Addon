...
public class BTAChunkProviderSimplex implements IChunkProvider
{
	...
	private BTAUtilsOpenSimplexOctaves ridgeNoiseGen;
	private BTAUtilsOpenSimplexOctaves erosionLevelNoiseGen;
	private BTAUtilsOpenSimplexOctaves erosionNoiseGen;
	private BTAUtilsOpenSimplexOctaves mountainNoiseGen;
	private BTAUtilsOpenSimplexOctaves oceanNoiseGen;
	...
	public BTAChunkProviderSimplex(World world, long seed, boolean mapFeaturesEnabled, BTAWorldConfigurationInfo generatorInfo)
	{
		...
		this.ridgeNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 2);
		this.erosionLevelNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 1);
		this.erosionNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 2);
		this.mountainNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 1);
		this.oceanNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 3);
		this.riverNoiseGen = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 8);
		this.riverNoiseGen2 = new BTAUtilsOpenSimplexOctaves(rand.nextLong(), 8);
