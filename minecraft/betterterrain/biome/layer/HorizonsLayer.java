...
public abstract class HorizonsLayer extends GenLayer {

	public HorizonsLayer(long par1) {
		super(par1);
	}
    ...
    {
    	HorizonsContinentLayer var3 = new HorizonsContinentLayer(1L);
        ...
        RiverLayer var20 = new RiverLayer(100L, var19, var16);
