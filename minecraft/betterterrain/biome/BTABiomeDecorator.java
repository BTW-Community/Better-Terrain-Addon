...
import betterterrain.feature.BTAWorldGenClay;
import betterterrain.feature.BTAWorldGenDecoFlowers;
import betterterrain.feature.BTAWorldGenFlowers;
import betterterrain.feature.BTAWorldGenMelons;
import betterterrain.feature.BTAWorldGenMinable;
import betterterrain.feature.BTAWorldGenMycelium;
import betterterrain.feature.BTAWorldGenOasis;
import betterterrain.feature.BTAWorldGenSteppe;
...
public class BTABiomeDecorator
{
	...
	public BTABiomeDecorator(BiomeGenBase par1BiomeGenBase)
	{
		...
		this.dirtGen = new BTAWorldGenMinable(Block.dirt.blockID, 0, 32, Block.stone.blockID);
		this.gravelGen = new BTAWorldGenMinable(Block.gravel.blockID, 0, 32, Block.stone.blockID);
		this.coalGen = new BTAWorldGenMinable(Block.oreCoal.blockID, 0, 16, Block.stone.blockID);
		this.ironGen = new BTAWorldGenMinable(Block.oreIron.blockID, 0, 8, Block.stone.blockID);
		this.goldGen = new BTAWorldGenMinable(Block.oreGold.blockID, 0, 8, Block.stone.blockID);
		this.redstoneGen = new BTAWorldGenMinable(Block.oreRedstone.blockID, 0, 7, Block.stone.blockID);
		this.diamondGen = new BTAWorldGenMinable(Block.oreDiamond.blockID, 0, 7, Block.stone.blockID);
		this.lapisGen = new BTAWorldGenMinable(Block.oreLapis.blockID, 0, 6, Block.stone.blockID);
		...
		stoneInGrassGen2 = new BTAWorldGenMinable(Block.stone.blockID, 48);
		...
		for (var1 = 0; var1 < this.sandPerChunk2; ++var1)
		{
			...
			if (this.currentWorld.provider.terrainType.canPerlinBeachesBeToggled() && !(this.currentWorld.getChunkProvider() instanceof ChunkProviderServer))
				if (!this.generatorInfo.generatePerlinBeaches())
					if (this.biome != BTABiomeConfiguration.tropics || ((BTAChunkProvider) this.currentWorld.getChunkProvider()).generatorInfo.getCompatMode().isVersionAtOrBelow(BTAEnumVersionCompat.V1_1_3))
