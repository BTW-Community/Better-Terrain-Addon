...
import betterterrain.biome.layer.HorizonsLayer;
...
public class HorizonsWorldChunkManager extends WorldChunkManager {
	...
	public HorizonsWorldChunkManager() {
	...
	public HorizonsWorldChunkManager(long seed, WorldType worldType) {
        this();
        GenLayer[] layers = HorizonsLayer.initializeAllBiomeGenerators(seed, worldType);
        this.genBiomes = layers[0];
        this.biomeIndexLayer = layers[1];
	}

	public HorizonsWorldChunkManager(World world) {
