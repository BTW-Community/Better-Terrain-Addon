...
public class Slider extends GuiButton
{
    ...
    private final SliderSettingHandler handler;
    
    public final int numSettings;

    public Slider(int id, int x, int y, int sizeX, int sizeY, String displayString, float startingValue, SliderSettingHandler handler, int numSettings)
    {
    ...
    public Slider(int id, int x, int y, int sizeX, int sizeY, String displayString, int startingValue, SliderSettingHandler handler, int numSettings)
    {
        super(id, x, y, sizeX, sizeY, displayString);
