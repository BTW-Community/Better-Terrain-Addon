...
{
	public final GeneratorOptionsGui guiGeneratorOptions;
	private final GuiCreateWorld guiCreateWorld;
	private BiomeOptionListGui guiBiomeOptionList;
	...
	public BiomeOptionsGui(GuiCreateWorld guiCreateWorld, GeneratorOptionsGui guiGeneratorOptions, String infoString) {
	...
	public void initGui() {
		...
		this.guiBiomeOptionList = new BiomeOptionListGui(this);
	...
	public void setGeneratorInfo(String infoString) {
		guiGeneratorOptions.worldGeneratorInfo = WorldConfigurationInfo.createInfoFromString(infoString);
	}

	static WorldConfigurationInfo getBiomeArray(GeneratorOptionsGui guiGeneratorOptions) {
