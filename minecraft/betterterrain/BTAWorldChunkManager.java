...
public class BTAWorldChunkManager extends WorldChunkManager {
	...
	public BTAWorldChunkManager(World world, BTAWorldConfigurationInfo generatorInfo) {
		this(generatorInfo);
        this.world = world;
        GenLayer[] layers = BTAGenLayer.initializeAllBiomeGenerators(world.getSeed(), world.getWorldInfo().getTerrainType(), generatorInfo);
