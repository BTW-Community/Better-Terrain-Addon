...
public class BTAWorldGenMycelium extends WorldGenerator
{
	...
	public BTAWorldGenMycelium(int par1, int par2)
	{
		minableBlockId = par1;
		numberOfBlocks = par2;
	...
	public BTAWorldGenMycelium(int par1, int par2, int replaceBlockId)
	{
		minableBlockId = par1;
		numberOfBlocks = par2;
